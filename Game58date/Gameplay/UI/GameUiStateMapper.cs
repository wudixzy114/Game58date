...
public static class GameUiStateMapper
{
    public static GameUiViewState Map(WorldLawRuntimeState state, GameUiContextState context, GameUiTheme theme)
    {
        ...
        return new GameUiViewState
        {
            ...
            MenuTitleText = context.MenuTitle,
            ...
            MenuSettingsText =
                $"Display: {(context.UiHidden ? "Hidden" : "Visible")}  |  Perception Boost: {(state.Perception.IsActive ? "Active" : "Passive")}  |  Input Focus: {(inputEnabled ? "Narrative" : "Travel")}  |  Debug HUD: {(context.DebugHudVisible ? "Visible" : "Hidden")}",
            MenuHintText = context.MenuHintText,
            MenuToggleButtonText = context.MenuVisible ? "Resume Journey" : "Open Pause",
            ...
            ReturnToRouterButtonText = "Return To Router",
            UiVisibilityButtonText = context.UiHidden ? "Show All UI" : "Hide All UI",
